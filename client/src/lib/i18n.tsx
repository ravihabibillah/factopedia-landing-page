...
const translations = {
  ...
  stats: {
    ...
    knowledgeCategories: { id: "Playlist Pengetahuan", en: "Knowledge Playlists" },
  },
  about: {
  ...
  categories: {
    ...
    subtitle: {
      id: "Empat playlist yang dikurasi dengan cermat, masing-masing penuh dengan cerita yang akan mengubah cara Anda melihat dunia.",
      en: "Four carefully curated playlists, each packed with stories that will change how you see the world.",
    },
    items: {
