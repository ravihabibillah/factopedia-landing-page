...
const translations = {
  ...
  about: {
    ...
    desc1: {
      id: "Factopedia adalah channel YouTube yang didedikasikan untuk mengungkap fakta-fakta paling menakjubkan, aneh, dan menakjubkan di dunia. Setiap hari pada pukul 09:00, kami menerbitkan video baru yang membawa Anda dalam perjalanan melalui sains, sejarah, hewan, budaya, dan misteri alam semesta.",
      en: "Factopedia is a YouTube channel dedicated to uncovering the world's most fascinating, strange, and wonderful facts. Every single day at 9:00 AM, we publish a new video that takes you on a journey through science, history, animals, cultures, and the mysteries of our universe.",
    },
    desc2: {
      id: "Dari palung laut terdalam hingga jangkauan terjauh luar angkasa, dari peradaban kuno hingga penemuan mutakhir — jika itu menarik, Anda akan menemukannya di sini.",
      en: "From the deepest ocean trenches to the farthest reaches of space, from ancient civilizations to cutting-edge discoveries — if it's fascinating, you'll find it here.",
    },
    features: {
      dailyUploads: { id: "Upload Harian", en: "Daily Uploads" },
      dailyUploadsDesc: { id: "Konten segar setiap hari pukul 09:00", en: "Fresh content every day at 9 AM" },
      researchBacked: { id: "Berbasis Riset", en: "Research-Backed" },
      researchBackedDesc: { id: "Diverifikasi dari sumber terpercaya", en: "Verified from reliable sources" },
      visualStories: { id: "Cerita Visual", en: "Visual Stories" },
      visualStoriesDesc: { id: "Kualitas produksi sinematik", en: "Cinematic production quality" },
      funLearning: { id: "Belajar Seru", en: "Fun Learning" },
      funLearningDesc: { id: "Edukasi yang menghibur", en: "Education that entertains" },
    },
    channelLive: { id: "Channel Aktif", en: "Live Channel" },
    channelDesc: { id: "Fakta baru setiap hari. Tanpa pengecualian.", en: "A new fact every day. No exceptions." },
